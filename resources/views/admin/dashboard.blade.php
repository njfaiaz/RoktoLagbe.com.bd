...
@push('style')
    <link rel="stylesheet" href="{{ asset('assets/admin/js/jquery-jvectormap-2.0.3.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/admin/js/plugin.css') }}" />
@endpush
...
@section('content')
    ...
    @push('footer_scripts')
        <script src="{{ asset('assets/admin/js/jvectormap.bundle.js') }}"></script> <!-- JVectorMap Plugin Js -->
        <script src="{{ asset('assets/admin/js/sparkline.bundle.js') }}"></script> <!-- Sparkline Plugin Js -->
